...
class ProjectArticleListModel {
  int errorCode;
  String errorMsg;
  ProjectArticleListBean data;

  ProjectArticleListModel.fromParams(
      {this.errorCode, this.errorMsg, this.data});

  factory ProjectArticleListModel(jsonStr) => jsonStr == null
      ? null
      : jsonStr is String
          ? new ProjectArticleListModel.fromJson(json.decode(jsonStr))
          : new ProjectArticleListModel.fromJson(jsonStr);

  ProjectArticleListModel.fromJson(jsonRes) {
    errorCode = jsonRes['errorCode'];
    errorMsg = jsonRes['errorMsg'];
    data = jsonRes['data'] == null
        ? null
        : new ProjectArticleListBean.fromJson(jsonRes['data']);
  }
...
class ProjectArticleListBean {
  ...
  int total;
  bool over;
  List<ProjectArticleBean> datas;

  ProjectArticleListBean.fromParams(
      {this.curPage,
      this.offset,
      this.pageCount,
      this.size,
  ...
  ProjectArticleListBean.fromJson(jsonRes) {
    ...
    for (var datasItem in datas == null ? [] : jsonRes['datas']) {
      datas.add(datasItem == null
          ? null
          : new ProjectArticleBean.fromJson(datasItem));
    }
  }
...
class ProjectArticleBean {
  ...
  String title;
  List<ProjectArticleTag> tags;

  ProjectArticleBean.fromParams(
      {this.chapterId,
      this.courseId,
      this.id,
      this.publishTime,
  ...
  ProjectArticleBean.fromJson(jsonRes) {
    ...
    superChapterName = StringUtil.urlDecoder(jsonRes['superChapterName']);
    title = StringUtil.urlDecoder(jsonRes['title']);
    tags = jsonRes['tags'] == null ? null : [];

    for (var tagsItem in tags == null ? [] : jsonRes['tags']) {
      tags.add(
          tagsItem == null ? null : new ProjectArticleTag.fromJson(tagsItem));
    }
  }
...
class ProjectArticleTag {
  String name;
  String url;

  ProjectArticleTag.fromParams({this.name, this.url});

  ProjectArticleTag.fromJson(jsonRes) {
    name = jsonRes['name'];
    url = jsonRes['url'];
  }
